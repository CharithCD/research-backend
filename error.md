...
research_backend_api    |     from .utils_asr import transcribe_bytes, convert_audio_to_mono_wav
research_backend_api    | ImportError: cannot import name 'convert_audio_to_mono_wav' from 'app.utils_asr' (/app/app/utils_asr.py)
...
research_backend_api    |   File "<frozen importlib._bootstrap_external>", line 940, in exec_module
research_backend_api    |   File "<frozen importlib._bootstrap>", line 241, in _call_with_frames_removed
research_backend_api    |   File "/app/app/main.py", line 11, in <module>
research_backend_api    |     from .utils_asr import transcribe_bytes, convert_audio_to_mono_wav
research_backend_api    | ImportError: cannot import name 'convert_audio_to_mono_wav' from 'app.utils_asr' (/app/app/utils_asr.py)
research_backend_api exited with code 1
research_backend_api    | ✓ config.json present; skip
...
research_backend_api    | ImportError: cannot import name 'convert_audio_to_mono_wav' from 'app.utils_asr' (/app/app/utils_asr.py)
research_backend_api exited with code 1
research_backend_caddy  | {"level":"error","ts":1757913759.1514137,"logger":"http.log.error","msg":"dial tcp: lookup api on 127.0.0.11:53: server misbehaving","request":{"remote_ip":"91.224.92.17","remote_port":"52790","client_ip":"91.224.92.17","proto":"HTTP/1.1","method":"GET","host":"157.245.99.84:80","uri":"/","headers":{}},"duration":0.00261266,"status":502,"err_id":"x0a973b07","err_trace":"reverseproxy.statusError (reverseproxy.go:1390)"}
research_backend_api    | ✓ config.json present; skip
research_backend_api    | ✓ preprocessor_config.json present; skip
research_backend_api    | ✓ vocab.json present; skip
research_backend_api    | ✓ model.safetensors present; skip
